...
function getFilesMetaTag(collectionName, files) {
    ...
    files.forEach(function (filePath, index) { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            ...
            isDiffTime = false;
            try {
                file = knotdb_1.readData(collectionName, filePath);
            }
            catch (error) { }
            if (file) {
                    ...
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0:
                                ...
                                return [4 /*yield*/, knotdb_1.addData(collectionName, fileTags)];
                            case 1:
                                // Adds file metatag to db
                                _a.sent();
                                ...
                                if (files.length === counter + 1) {
                                    console.log('Done');
                                    knotdb_1.createFilesIndex(collectionName);
                                }
                                counter++;
                                return [2 /*return*/];
                        }
